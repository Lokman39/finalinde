    ...
    <div class="container">
        <div class="row"> 
            <div class="col-md-12"> <br />
               ...
               <div align="right"> <a href="{{route('user.create')}}" class="btn btn-primary">ADD MEMBER</a>
            </div><br>
            ...
            <table class="table table-bordered table-hover"> 
                    ...
                    @foreach($users as $row) <tr>
                        ...
                        <td>{{$row['fname']}}</td>
                        <td>{{$row['lname']}}</td>
                        <td><a href="{{action('finalincontroller@edit', $row['id'])}}"  class="btn btn-info">EDIT</a></td> 
                        <td>
